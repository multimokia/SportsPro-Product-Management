...
namespace assignment1.Controllers
{
    public class TechniciansController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TechnicianId,FirstName,LastName,StreetAddress,City,PostalCode,Country,EmailAddress,PhoneNumber")] Technician technician)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("TechnicianId,FirstName,LastName,StreetAddress,City,PostalCode,Country,EmailAddress,PhoneNumber")] Technician technician)
        {
